...
function Footer() {
  return (
    <div className='w-full h-screen bg-[#F1F1F1] pt-20 pl-16 pb-10 flex'>
        <div className='w-1/2 flex flex-col justify-between h-full'>
           <div>
           <h1 className='text-[8vw] text-[#212121] font-bold leading-none tracking-tighter -mb-7'>EYE-</h1>
            <h1 className='text-[8vw] text-[#212121] font-bold leading-none tracking-tighter'>OPENING</h1>
          </div>
        ...
        <div className='w-1/2'>
        <h1 className='text-[6vw] text-[#212121] font-bold leading-none tracking-tighter -mb-7'>PRESENTATIONS</h1>
        <div className='m-20'>
            <h1 className='text-lg pb-7 '>Social:</h1>
            <h2 className=' flex gap-8 text-sm font-semibold text-[#5A5A5A]'>
        {["Instagram","Facebook","LinkedIn","Behance"].map((item,index)=>(
        <a key={index} className={`text-[1.15vw] cursor-pointer underline underline-offset-4 font-semibold ${index===4&& "ml-40"}`}>{item}</a>
         ) )}
    </h2>
        </div>
        <div className='m-20'>
            <h1 className='text-lg pb-4 '>Mail:</h1>
            <h2 className='text-[1.15vw] flex gap-8  underline underline-offset-4 font-semibold text-[#5A5A5A]'>hello@ochi.design    </h2>
        </div>
        </div>
    </div>
  )
